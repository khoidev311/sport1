  ...
  return (
    <div className={twMerge("group", className)}>
      ...
      >
        <div
          className={twMerge(
            "absolute left-2 top-1/2 z-10 flex -translate-y-1/2 items-center justify-between bg-white px-2 text-gray-500 transition-all duration-100 group-focus-within:text-blue-500",
