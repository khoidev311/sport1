...
export interface AdminTeamTableRowActionProps {
  id: Key;
  onClickEdit: TableOnclickFunctionType<number>;
  onClickDelete: TableOnclickFunctionType<number>;
}

const AdminTeamTableRowAction = ({ id, onClickEdit, onClickDelete }: AdminTeamTableRowActionProps) => {
  return (
...
export default memo(AdminTeamTableRowAction);
