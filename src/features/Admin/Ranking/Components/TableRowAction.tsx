...
export interface AdminRankTableRowActionProps {
  id: Key;
  onClickEdit: TableOnclickFunctionType<number>;
  onClickDelete: TableOnclickFunctionType<number>;
}

const AdminRankTableRowAction = ({ id, onClickEdit, onClickDelete }: AdminRankTableRowActionProps) => {
  return (
...
export default memo(AdminRankTableRowAction);
