...
export interface AdminFixtureTableRowActionProps {
  id: Key;
  onClickEdit: TableOnclickFunctionType<number>;
  onClickDelete: TableOnclickFunctionType<number>;
}

const AdminFixtureTableRowAction = ({ id, onClickEdit, onClickDelete }: AdminFixtureTableRowActionProps) => {
  return (
...
export default memo(AdminFixtureTableRowAction);
